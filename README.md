...
This project demonstrates how to automatically deploy a static website using **AWS CodePipeline** and **Amazon S3**.  
Whenever you push new code to GitHub, the pipeline updates the live site automatically.
...
### **Source Stage**
Pulls the latest code from GitHub using **GitHub App** integration.
